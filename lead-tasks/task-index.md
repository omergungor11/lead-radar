...
|-------|------|-------|------|-------------|--------|---------|---------|
| 0 | Project Setup | 7 | 4 | 0 | 0 | 3 | 0 |
| 1 | MVP — Panel + Places + Pipeline | 11 | 0 | 0 | 0 | 11 | 0 |
| **Total** | | **18** | **4** | **0** | **0** | **14** | **0** |
...
|----|------|-------|-----------|--------|-------------|
| TASK-001 | Repo + tooling init (Next.js iskeleti) | devops | S | PENDING | - |
...
| TASK-007 | Git repo init + GitHub public + first push | devops | S | PENDING | TASK-002..004 |
...
| ID | Task | Agent | Complexity | Status | Dependencies |
|----|------|-------|-----------|--------|-------------|
| TASK-101 | Next.js 15 + Tailwind + shadcn + Prisma + Vitest + Playwright iskeleti, `.env.example`, CI | orchestrator + devops | M | PENDING | TASK-007 |
